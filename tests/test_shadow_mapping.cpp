...
int main()
{
    ...
    // -------------------------
    Shader shader("../shader/shadow_mapping/shadow_mapping.vs", "../shader/shadow_mapping/shadow_mapping.fs");
    Shader simpleDepthShader("../shader/shadow_mapping/shadow_mapping_depth.vs", "../shader/shadow_mapping/shadow_mapping_depth.fs");
